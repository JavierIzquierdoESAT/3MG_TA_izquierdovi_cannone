...
inline Vec2 Vec2::operator+(float value) { return Vec2(x + value, y + value); }
...
inline float Vec2::Magnitude() const { return sqrtf(x * x + y * y); }
...
inline float Vec2::SqrMagnitude() const { return x * x + y * y; }
...
inline float Vec2::Radians(const Vec2 v) { return atan2f(v.y, v.x); }

inline float Vec2::DotProduct(Vec2 a, Vec2 b) { return a.x * b.x + a.y * b.y; }
}  // namespace coma
#endif
